...
INSERT INTO DETAIL_PELANGGARAN (id_dosen, id_tata_tertib, id_mahasiswa, id_sanksi, tugas_khusus, surat, status)
VALUES
    (2, 1, 2, 5, 'Menulis esai tentang kedisiplinan', NULL, 'pending'),
    (2, 2, 3, 4, 'Mengikuti pelatihan anti kekerasan', NULL, 'terverifikasi'),
    (3, 3, 4, 3, 'Membuat poster tentang waktu disiplin', NULL, 'pending'),
    (4, 4, 5, 2, 'Menyelesaikan tugas tambahan', NULL, 'terverifikasi'),
    (5, 5, 6, 1, NULL, NULL, 'pending');
...
INSERT INTO NEWS (judul, konten, penulis_id, gambar)
VALUES
    ('Perubahan Tata Tertib Kampus', 'Mulai semester ini, aturan terkait kehadiran diperketat.', 1, NULL),
    ('Pelatihan Anti Kekerasan', 'Mahasiswa yang melanggar akan diwajibkan mengikuti pelatihan.', 2, NULL),
    ('Peningkatan Disiplin', 'Kami mengajak seluruh mahasiswa meningkatkan kedisiplinan.', 3, NULL),
    ('Larangan Merokok', 'Merokok di area kampus akan dikenakan sanksi tegas.', 4, NULL),
    ('Penggunaan Seragam Baru', 'Setiap mahasiswa wajib menggunakan seragam sesuai program studi.', 5, NULL);
